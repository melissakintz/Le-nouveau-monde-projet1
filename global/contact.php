        ...
        <form action = "resultat.php" method = "POST">
            <fieldset class="uk-fieldset">
                ...
                <div class="uk-margin">
                    ...
                    <p><input required class="uk-input" type="text" placeholder="Nom Prénom" name="nomPrenom"></p>

                    <p><input class="uk-input" type="email" placeholder="Votre email" name="email" required ></p>
                </div>
                <div class="uk-margin">
